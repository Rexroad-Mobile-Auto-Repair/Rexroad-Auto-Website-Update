 ...
 * page-vehicle-make.php, rendered as the "Ford" fixture page.
 *
 * Usage: php tests/vehicles/lib/render-make-preview.php > preview.html
 */
...
echo '<title>Vehicle Make Page Preview — Ford</title>';
echo $links;
